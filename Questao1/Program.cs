    ...
    class Program {
        static void Main(string[] args) {
            ...
            if (resp == 's' || resp == 'S') {
                ...
                conta = new ContaBancaria(numero, titular, depositoInicial, saldo);
            }
            else {
            ...
            Console.WriteLine("Conta: " + conta.numero.ToString() + " Titular: " + conta.titular + " Saldo: " + conta.saldo.ToString());
